            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        Reach out to me to discuss potential job opportunities and start collaborating on something amazing!
                    </p>
                ...
                {/* Form Submission */}
                <form action="https://getform.io/f/adrrooda" method="POST" className="xl:pl-10 2xl:pl-20">
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Chan Wei Hao" className="text-field reveal-up" />
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="weihao@example.com" className="text-field reveal-up" />
